      ...
      <div className="pt-6 px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-4 relative z-50 w-full mb-8 border-b border-white/5 pb-6 bg-[#050812]/40 backdrop-blur-md">
        ...
        <div className="flex flex-wrap items-center justify-center sm:justify-end gap-3 w-full sm:w-auto">
          <div className="hidden lg:flex items-center gap-4 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 mr-2">
            ...
            <span className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-slate-400"><Save className="w-3 h-3" /> Auto Saved</span>
            <span className="w-px h-3 bg-white/20" />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 flex flex-col flex-1">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {dummyRecent.map(r => (
              <div key={r.id} className="bg-[#10162A]/60 border border-white/5 rounded-2xl overflow-hidden group hover:border-blue-500/30 transition-all shadow-lg hover:shadow-[0_0_30px_rgba(59,130,246,0.1)]">
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center text-[9px] text-slate-500 font-bold uppercase tracking-widest mb-3">
                    <span>{r.duration} • {r.resolution}</span>
                    <span className="text-blue-400">{r.created}</span>
                  </div>
                  <div className="flex gap-2">
                    ...
                    <button className="p-1.5 bg-white/5 hover:text-red-400 rounded border border-white/5 text-slate-300 transition-colors"><Trash2 className="w-3.5 h-3.5" /></button>
                  </div>
                </div>
              </div>
            ))}
