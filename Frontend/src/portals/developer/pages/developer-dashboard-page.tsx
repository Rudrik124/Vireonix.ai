...
export function DeveloperDashboardPage() {
  ...
  const menuItems = [
    ...
    { label: "Authentication Monitoring", path: "/developer/authentication-monitoring", icon: Shield, desc: "Login attempts, IPs, devices, browsers", count: "Secure" },
    { label: "Prompt Security Monitoring", path: "/developer/prompt-security-monitoring", icon: AlertCircle, desc: "NSFW, violence, injection, copyright abuse", count: "Active" },
    { label: "File Upload Security Monitoring", path: "/developer/file-upload-security-monitoring", icon: HardDrive, desc: "Images, videos, audio, malware, MIME type validation", count: "Active" },
    { label: "Rate Limit Monitoring", path: "/developer/rate-limit-monitoring", icon: Zap, desc: "Users hitting limits, blocked requests, API abuse", count: "Active" },
    { label: "AI Cost Monitoring", path: "/developer/ai-cost-monitoring", icon: TrendingUp, desc: "Runway requests, costs, daily/weekly/monthly views", count: "Active" },
    { label: "API Security Monitoring", path: "/developer/api-security-monitoring", icon: Lock, desc: "Total requests, blocked, errors, bot activity, attacks", count: "Active" },
    { label: "User Risk Scoring", path: "/developer/user-risk-scoring", icon: AlertTriangle, desc: "Safe, suspicious, dangerous users by security events", count: "Active" },
    { label: "Security Alerts Center", path: "/developer/security-alerts", icon: AlertCircle, desc: "Malware, injection, abuse, device login, video generation alerts", count: "Active" },
    { label: "Admin Activity Monitoring", path: "/developer/admin-activity", icon: BarChart3, desc: "Track logins, bans, deletes, role/settings changes, audit history", count: "Active" },
    { label: "Audit Log System", path: "/developer/audit-log", icon: FileText, desc: "Track logins, uploads, prompts, videos, admin actions with search/export", count: "Active" },
    { label: "Threat Visualization", path: "/developer/threat-visualization", icon: Globe2, desc: "Monitor global threats, attacks by country, IP geolocation, real-time security incidents", count: "Active" },
    // Security Portal
    { label: "Security Portal", path: "/security", icon: Shield, desc: "Complete security monitoring dashboard with real-time threats and audit logs", count: "Admin" },
