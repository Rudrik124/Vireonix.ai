...
export function TesterCreditsPage() {
  ...
  if (authLoading || isLoading) {
    return <div className="flex items-center justify-center min-h-screen bg-[#050816] text-cyan-400 font-bold">Loading your credits...</div>;
  }
      ...
      <div className="relative z-10 container mx-auto px-6 py-8">
        ...
        <footer className="mt-16 text-center pb-8">
          ...
          <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-600 space-y-2">
            <p className="text-slate-500">VEYTRIX.AI AI CREDIT MANAGEMENT</p>
