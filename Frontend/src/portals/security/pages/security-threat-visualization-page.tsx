...
import { ThreatVisualizationDashboard } from "../../../portals/developer/components/threat-visualization-dashboard";
import { logSecurityPortalActivity } from "../../../services/security-portal.service";

export function SecurityThreatVisualizationPage() {
  ...
  useEffect(() => {
    if (profile) {
      logSecurityPortalActivity({
        ...
        module: "Threat Visualization",
        action: "Accessed Threat Visualization module",
      }).catch(console.error);
    }
  }, [profile]);
